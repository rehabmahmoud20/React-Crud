...
const EmployeeCard = ({ employee }) => {
  ...
  return (
    <div className="card flex w-fit py-3">
      <div className="card-img  border-r">
        ...
        <div className="img-icons flex mx-auto w-fit">
          <MdModeEdit className="mr-4 text-xs muted" />
          <AiOutlinePauseCircle className="mr-4 text-xs muted" />
          <AiFillDelete className="text-xs muted" />
        </div>
      </div>
      <div className="card-content capitalize">
        ...
        <div className="emp-data flex space-x-32">
